 ...
 */
public class ExpensesHistoryAdapter extends BaseRecyclerViewAdapter<ExpensesHistoryAdapter.ViewHolder> {
    ...
    public ExpensesHistoryAdapter(Context context, BaseViewHolder.RecyclerClickListener onRecyclerClickListener, List<Expense> mExpensesList) {
    ...
    @Override
    public ExpensesHistoryAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_expense_item, parent, false);
        return new ExpensesHistoryAdapter.ViewHolder(v, onRecyclerClickListener);
    }

    @Override
    public void onBindViewHolder(ExpensesHistoryAdapter.ViewHolder holder, int position) {
